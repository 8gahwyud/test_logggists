...
export default function BottomNav({ onFinanceClick }) {
  ...
  // Проверяем, есть ли минусовой баланс
  const hasNegativeBalance = balance && Number(balance.available?.replace('₽', '') || 0) < 0
